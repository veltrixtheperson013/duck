...
const UTILITY_COMMANDS = [
  ...
  "Plus: `duck roast @user` / `duck compliment @user`",
  "Plus: `duck choose pizza, tacos, sushi` / `duck rate <thing>` / `duck wouldyourather`",
...
const TOOL_REQUIREMENTS = {
  ...
  lock_channel: PermissionsBitField.Flags.ManageRoles,
  unlock_channel: PermissionsBitField.Flags.ManageRoles,
...
const COMMAND_PRESENTATION = Object.freeze({
  ...
  roast: ["Friendly Fire", DUCK_COLORS.fun],
  compliment: ["Emergency Positivity", DUCK_COLORS.fun],
  choose: ["Duck Decides", DUCK_COLORS.fun],
  rate: ["Scientific Rating", DUCK_COLORS.fun],
  wouldyourather: ["Would You Rather", DUCK_COLORS.fun],
  rps: ["Rock, Paper, Scissors", DUCK_COLORS.fun],
  fortune: ["Pond Fortune", DUCK_COLORS.fun],
  topic: ["Conversation Starter", DUCK_COLORS.fun],
  joke: ["Pond Joke", DUCK_COLORS.fun],
  number: ["Random Number", DUCK_COLORS.fun],
  battle: ["Pond Battle", DUCK_COLORS.fun],
  dramatic: ["Grand Entrance", DUCK_COLORS.fun],
  conspiracy: ["Obviously Fake Theory", DUCK_COLORS.fun],
  challenge: ["Mini-Challenge", DUCK_COLORS.fun],
  caption: ["Meme Caption", DUCK_COLORS.fun],
